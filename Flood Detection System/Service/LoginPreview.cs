...
namespace Flood_Detection_System.Service
{
    public class LoginPreview : ILoginPreview
    {
        public static object PreviewPage(WeatherApiInputOutputModel weatherApiInputModel)
        {
